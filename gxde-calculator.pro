...
TRANSLATIONS += $$PWD/translations/gxde-calculator.ts \
                $$PWD/translations/gxde-calculator_zh_CN.ts

isEmpty(BINDIR):BINDIR=/usr/bin
isEmpty(APPDIR):APPDIR=/usr/share/applications
isEmpty(DSRDIR):DSRDIR=/usr/share/gxde-calculator
...
icon_files.files = $$PWD/images/gxde-calculator.svg
...
translations.path = /usr/share/gxde-calculator/translations/
